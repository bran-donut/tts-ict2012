...
export default function Sampling() {
  ...
  }, [router.query.index]);  // Ensure to track `router.query.index` as a dependency
    ...
    <Layout>
      ...
      <section className="grid grid-flow-row bg-#f0f2f5">
        <form>
            ...
            <div className="flex flex-col justify-center h-full min-w-full text-justify bg-white border-2 rounded-md">
              ...
              <div className="grid grid-cols-2 gap-4 px-5 py-1">
                <DisabledDropdown
                  ...
                  index={router.query.index}  // Removed duplicate `index={router.query.index}`
                />
              </div>
          ...
          <div className="flex flex-col items-center justify-end w-full gap-3 py-5 bg-white px-14 md:flex-row">
            <Link href="/schedule">
            ...
            <button
              ...
              className="px-10 py-2 ml-4 transition-colors duration-150 bg-white border-2 rounded-sm text-tts-red hover:bg-tts-red/80 border-tts-red"
            >
              Save & Exit
            </button>
            {allowSubmit ? (
              <button
                ...
                className="px-10 py-2 text-white transition-colors duration-150 border-2 rounded-sm bg-tts-red hover:bg-tts-red/80 border-tts-red"
              >
                Submit details
              </button>
            ) : (
              <button
                type="button"
                className="px-10 py-2 text-white transition-colors duration-150 bg-gray-400 border-2 border-gray-400 rounded-sm"
              >
                Submit details
              </button>
            )}
